...
function customEntries(obj) {
  ...
  return typeof obj === "object"
    ? Object.entries(obj)
    : "Помилка: Аргумент не є об'єктом.";
}
...
function customObjectFromEntries(entries) {
  ...
  return typeof entries !== "object"
    ? "Помилка: Вхідний аргумент має бути масивом."
    : Object.fromEntries(
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  if (typeof obj1 === "object" && typeof obj2 === "object") {
    ...
    Object.freeze(obj1);
    return Object.isFrozen(obj1) ? obj1 : "Помилка: об'єкт не було заморожено!";
  } else {
    return null;
  }
}
...
function filterObjectsByKey(arr, key) {
  ...
  return typeof arr === "object"
    ? arr.filter((value) => value.hasOwnProperty(key))
    : [];
}
...
function checkAndPreventExtensions(obj) {
  ...
  if (typeof obj === "object" && Object.isExtensible(obj)) {
...
function getObjectValuesSum(obj) {
  ...
  // Повертаємо суму
  return typeof obj === "object"
    ? Object.values(obj).reduce((res, value) => res + value)
    : 0;
}
